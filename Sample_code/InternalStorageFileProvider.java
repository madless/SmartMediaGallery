package com.wb.vapps.resources;
...
public class InternalStorageFileProvider extends ContentProvider {
	...
	public static final String AUTHORITY = "com.wb.vapps.internal_storage_provider";
	...
	Intent emailIntent = new Intent(android.content.Intent.ACTION_SEND); 
				...
				emailIntent.putExtra(Intent.EXTRA_STREAM, Uri.parse(("content://" + "com.shevart.mygallery.Music" + Service.getFileName(myMediaPlayer.getCurrentSound().getSoundAddress()))));
	}
